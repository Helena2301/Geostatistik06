...
#getGridTopology(as(Rljz, "SpatialGrid"))
#str(Rljz)
...
```{r Aufgabe 13d}
var(Ca)
#var1.var ist max. 109.1
#NoData <- interpol_Ca
#NoData@data$var1.pred > 109.1 <- NA

#NoData@data$var1.pred <- NA
#NoData@data$var1.var <- NA
#NoData <- NULL
```
...
#Rinterpol_Ca <- mask(NoData, interpol_Ca)
#Darstellung
library(lattice)
