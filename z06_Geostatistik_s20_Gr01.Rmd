...
bboxSPDFljz <- bbox(SPDFljz)

extent(Rljz) <- extent(bbox(SPDFljz))
dim(Rljz) <- c(44, 44) #vllt andere Pixelsize?

#Spatial Grid
GT <- GridTopology(cellcentre.offset = c(490441, 3121290),
                   cellsize = c(44, 44),
                   cells.dim = c(224, 259))
